...
describe 'Due Date' do
  ...
  # Story: As a developer with a TaskList with and without due dates, I can list
  # all the not completed items in order of due date, and then the items without due dates.
  it 'Tasklist can organize list of tasks by due date, and then items without due date' do
    # creates tasks and task list
    list = TaskList.new
    task1 = Task.new
    task2 = Task.new
    ...
    task3.title = 'Get a career in coding'
    task4.title = 'Fix this Code!'
    new_task.title = 'Fill in due_date for task'
    # sets due dates for tasks
    date1 = Date.new(2022, 5, 19)
    task1.deadline(date1)
    date2 = Date.new(2022, 8, 20)
    ...
    expect(list.by_due_date).to eq ['Have this interview',
                                    'Fix this Code!',
                                    'Get a career in coding',
                                    'Fill in due_date for task']
  end
end
